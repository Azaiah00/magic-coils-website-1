...
// Only the social platforms we actually have live profiles on get
// icons here. YouTube and Facebook were placeholders with `href="#"`
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-12 mb-20">
          ...
          >
            ...
            <div className="flex items-center gap-6">
              <a href="https://instagram.com/magiccoilsofficial" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-primary hover:text-accent transition-colors duration-300">
                <Instagram className="w-5 h-5" strokeWidth={1.5} />
              </a>
              <a href="https://tiktok.com/@magiccoilsofficial" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-primary hover:text-accent transition-colors duration-300">
