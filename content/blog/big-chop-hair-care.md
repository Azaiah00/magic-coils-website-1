---
title: "Big Chop Recovery: Building Length in the First Year"
slug: "big-chop-hair-care"
...
featuredImageAlt: "Black woman after a big chop with a newly-cut TWA (teeny weeny afro)"
keywords:
  - "big chop hair care"
  - "twa care routine"
  - "natural hair growth after big chop"
...
relatedProducts:
  ...
  - "strengthening-serum"
faqs:
  - q: "How much hair grows in a year after a big chop?"
    a: "The scalp average is 6 inches of growth per year, but Black natural hair often appears to grow slower because shrinkage hides up to 75% of actual length. By month 12, most people see 4-6 inches of stretched length, which translates to 1-3 inches of unstretched visible length. The hair IS growing — shrinkage just hides it."
  - q: "Should I trim my hair after a big chop?"
    a: "Wait until at least month 4-6 before your first trim. The first few months are about establishing a healthy routine; trimming too early sets you back. After month 6, light dustings (less than 1/4 inch) every 3 months is the standard for retaining length."
  - q: "Why is my new growth so dry?"
    a: "Two reasons. First, post-big-chop hair has shorter exposed strands where natural scalp oils haven't had time to travel down. Second, the new growth pattern at your roots may be tighter than what you had before, which makes the strand structure naturally drier. The 3-in-1 Leave-In and Moisturizing Cream layered together solve both."
  - q: "Can I wear protective styles right after the big chop?"
    a: "Yes, but with restraint. Loose styles like puff buns, braid-outs, and twist-outs are fine immediately. Heavy braids, sew-ins, or tight extensions should wait until month 3 or beyond — the tension on still-recovering hair can cause traction alopecia at the temples and edges."
  - q: "How often should I deep condition after a big chop?"
    a: "Weekly for the first 3 months — this is when your hair is rebuilding moisture habits. After month 3, drop to bi-weekly. After month 6, once-monthly maintenance unless you're heat-styling or living somewhere with extreme weather (very dry winters, very humid summers both stress hair)."
---
...
**What to do:**
- **Wash 2x per week** with **[Peppermint Detox Shampoo](/product/peppermint-shampoo)**. The peppermint manages the oil while the tea tree keeps your scalp balanced as it adjusts.
- **Condition** with **[Moisture Rich Conditioner](/product/moisture-conditioner)** — you don't need to detangle (too short to tangle), but the conditioner helps your strands transition out of chemical-processing residue.
- **Style** with just **[3-In-1 Leave In Treatment](/product/leave-in-treatment)** patted into damp hair. That's it. Resist the urge to layer.
...
If you don't know your pattern yet, read our [curl pattern identification guide](/blog/how-to-identify-your-curl-pattern) and figure it out. The routine you'll need for the next 9 months depends on this.

**What to do:**
- Continue weekly washes, alternating **[Peppermint Detox](/product/peppermint-shampoo)** and **[Intense Hydration Shampoo](/product/hydration-shampoo)**
- Start a **weekly deep conditioning** session — apply **[Moisture Rich Conditioner](/product/moisture-conditioner)** generously, cover with a plastic cap, sit for 20 minutes (with body heat) before rinsing
- Begin layering: **[3-In-1 Leave In Treatment](/product/leave-in-treatment)** on soaking-wet hair, then a small amount of **[Honey & Argan Curl Custard](/product/curl-custard)** to start defining the pattern
- **Try a wash-and-go** — even a half-inch TWA can have visible coil definition. This is when many women fall in love with their texture for the first time.
...
**What to do:**
- **First trim** between month 4 and month 6 — find a stylist who specializes in natural hair. Look at our [Stylist Directory](/directory) for Magic Coils-certified professionals. The trim should be small (under 1/4 inch) and only to even out ends, not to "shape."
...
- **Add overnight refreshing.** Spritz with water + a tiny bit of **[3-In-1 Leave In Treatment](/product/leave-in-treatment)** in a spray bottle each morning. This is the daily habit that makes wash-and-gos last 5+ days instead of 2.
...
- **Add the [Strengthening Serum](/product/strengthening-serum)** to your routine if you haven't yet. As length increases, ends become more prone to breakage. The serum's argan + vitamin C combination seals cuticles and protects against day-to-day wear.
...
1. **[Peppermint Detox Shampoo](/product/peppermint-shampoo)** — scalp reset weekly
2. **[Intense Hydration Shampoo](/product/hydration-shampoo)** — gentle cleanse on alternate weeks
3. **[Moisture Rich Conditioner](/product/moisture-conditioner)** — your detangler and deep conditioner
4. **[3-In-1 Leave In Treatment](/product/leave-in-treatment)** — daily and weekly moisture lock

By month 4, you'll likely add:

5. **[Honey & Argan Curl Custard](/product/curl-custard)** — definition
6. **[Moisturizing Cream](/product/moisturizing-cream)** — daily refresh and seal
7. **[Strengthening Serum](/product/strengthening-serum)** — heat protection + shine

The whole stack is available as **[the Full Routine Bundle](/bundles)** — saves about $25 vs. buying individually, and you have everything you need for the full year-one journey in one purchase.
...
Take our **[60-second Hair Quiz](/quiz)** — tell us your texture, your goal, and how you currently style. We'll send a routine sized to where you actually are in the journey, not a generic "natural hair starter pack."
