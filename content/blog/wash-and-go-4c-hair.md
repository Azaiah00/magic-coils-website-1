---
title: "Mastering the Perfect Wash & Go for 4C Hair"
slug: "wash-and-go-4c-hair"
...
featuredImageAlt: "Black woman with defined 4c coils after a Magic Coils wash and go routine"
keywords:
  - "wash and go 4c hair"
  - "4c hair routine"
...
relatedProducts:
  ...
  - "curl-custard"
faqs:
  - q: "How long does a wash and go last on 4c hair?"
    a: "A properly done wash and go on 4c hair lasts 5–7 days with overnight pineappling and a satin pillowcase. The biggest predictor of longevity isn't the products — it's whether you sealed in moisture during styling and protected coils each night."
  - q: "Can I do a wash and go without gel?"
    a: "Yes, but you'll trade hold for softness. Skip the Curl Custard and use only the 3-in-1 Leave-In and a sealing oil — coils will be soft and touchable, but definition fades faster and shrinkage is more pronounced. For 5-day definition, you need a hold product."
  - q: "Why does my 4c hair shrink so much during a wash and go?"
    a: "Shrinkage is normal and healthy. 4c coils naturally shrink 50–75% when wet, which is why your hair looks dramatically shorter wet vs. stretched. The wash and go technique below works WITH shrinkage rather than against it, focusing on definition rather than length retention."
  - q: "Do I need to detangle before doing a wash and go?"
    a: "Yes — always detangle with conditioner or 3-in-1 Leave-In in the shower, when hair is at maximum slip. Detangling dry or with shampoo causes breakage. Use your fingers first, then a wide-tooth comb starting from the ends and working up."
  - q: "What if my wash and go gets crunchy?"
    a: "Crunch is the gel cast hardening as it dries. After hair is 100% dry, scrunch it with a tiny amount of oil to break the cast — this is called SOTC (Scrunch Out The Crunch). The crunch protected your coils during dry; once dry, you remove it to reveal soft, defined coils."
---
...
1. **[Peppermint Detox Shampoo](/product/peppermint-shampoo)** — cleanses without stripping. The peppermint tingle isn't marketing; it's tea tree and peppermint oils that genuinely reset a product-heavy scalp.
2. **[Moisture Rich Conditioner](/product/moisture-conditioner)** — your detangling tool. Apply generously, never skip.
3. **[3-In-1 Leave In Treatment](/product/leave-in-treatment)** — moisture lock with argan oil, vitamin C, and honey oil. This is the layer most people skip and then wonder why their wash and go feels dry by day three.
4. **[Honey & Argan Curl Custard](/product/curl-custard)** — your definition + hold product. Coils pop without crunch when applied correctly.
...
1. Spray or apply a generous amount to soaking-wet hair (a pump or two per section depending on density)
2. Smooth from root to tip with your hands, then **rake your fingers through** to evenly distribute
3. Pull each coil down slightly to "stretch" the soaking water + product mix through every strand
...
For each section:
1. Scoop about a quarter-sized amount of custard
2. Rub it between your palms to warm and emulsify it
3. **Praying-hands method** — smooth your palms down each section like you're praying
4. Then **rake through** with your fingers from root to tip
5. Finish with the **shingling technique** for the most definition: take each individual coil clump, coat it from root to tip between your thumb and index finger, then release
...
1. **Air-dry only** (most definition, takes 4–6 hours) — sit by a window if you can, or near a fan on its lowest setting
2. **Diffuse on cool, low** (faster, slightly less definition) — point the diffuser bowl-up under each section, don't move it around
3. **Diffuse on warm, low** (fastest, noticeable definition loss) — only do this if you're in a real time crunch
...
1. Pineapple (loose high ponytail on top of your head) OR a large satin bonnet
2. Sleep on a satin pillowcase as backup
...
1. **Not enough water in the hair when applying products.** Soaking wet means water dripping. Damp doesn't work for 4c.
2. **Touching wet hair while it dries.** Even one head-flip destroys definition. Set the timer.
3. **Using gel meant for 3a/3b curls.** Most "curl creams" on Sephora shelves are too light and have no hold. The Magic Coils Custard is formulated for 4c hold specifically.
4. **Skipping the cool-water rinse.** This single 15-second step compounds shine for the entire cycle.
5. **Using a terrycloth towel.** Microfiber or cotton t-shirt only. Always.
...
- **[Peppermint Detox Shampoo](/product/peppermint-shampoo)** — $17.95
- **[Moisture Rich Conditioner](/product/moisture-conditioner)** — $16.97
- **[3-In-1 Leave In Treatment](/product/leave-in-treatment)** — $16.95
- **[Honey & Argan Curl Custard](/product/curl-custard)** — varies

Or get all four (plus the Strengthening Serum and Moisturizing Cream) in **[the Full Routine Bundle](/bundles)** — saves about $25 versus buying individually.

## Not sure if this routine is right for your hair?

Take our [60-second Hair Quiz](/quiz) — three questions about your texture, your goals, and how you typically style. We'll send you a personalized routine instead of the universal wash-and-go above. The quiz is especially useful if you're between hair types (4a/4b/4c borderline) or have specific concerns like heat damage recovery, scalp sensitivity, or color-treated strands.
